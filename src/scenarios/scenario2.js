...

{
    ...
    myHouse.devices.bedroom_alarm1.setAlarm(8, 0)
    myHouse.devices.bedroom_alarm2.setAlarm(7, 0)
    ...
    //world.beliefs.declare('room outside')
    ...
    world.beliefs.declare('linked corridor bathroom')
    world.beliefs.declare('linked bedroom corridor')
    world.beliefs.declare('linked garden outside')
    world.beliefs.declare('linked outside garden')
    world.beliefs.declare('linked living_room garden')
    world.beliefs.declare('linked garden living_room')
    ...
    Clock.global.observe('mm', (mm) => {
        ...
        if (time.hh == 8 && time.mm == 15) {
            myHouse.people.james.moveTo('garden')
            myHouse.people.lily.moveTo('living_room')

        }
        if (time.hh == 8 && time.mm == 30) {
            myHouse.people.james.moveTo('outside')
        }
        ...
        if (time.hh == 9 && time.mm == 15) {
            //myHouse.people.james.moveTo('corridor')
            myHouse.people.lily.moveTo('garden')
        }
        if (time.hh == 9 && time.mm == 30) {
            //myHouse.people.james.moveTo('corridor')
            myHouse.people.lily.moveTo('outside')
            world.beliefs.declare('is-dirty bathroom')
        ...
        if (time.hh == 21 && time.mm == 0) {
            ...
            myHouse.people.james.moveTo('little_bathroom')
